...
//        $items->whereNotNull('channel_id');
        ...
        return view('courses/index', compact('items', 'request'));
    }
    ...
    {
        if (Auth::guest())
            return redirect('login?backUrl=courses/' . $id);
        ...
        try {
            ...
            if ($e instanceof InsufficientFunds) {
                ...
                return redirect('/student/wallet?amount=' . $needToDeposit . '&backUrl=/courses/' . $course->id)->withErrors([
