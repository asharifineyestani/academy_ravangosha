                            ...
                            <div class="col-12">
                                <div class="card border">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="mb-0">If you wish to find out the skills that should be covered in a
                                        ...
                                        <div class="collapse" id="collapseContent">
                                            <p class="my-3">We focus a great deal on the understanding of behavioral
                                                ...
                                                rounded Digital Marketer. We understand that theory is important to
                                                build a solid foundation, we understand that theory alone isn’t going to
                                            ...
                                            <p class="mb-0">Behavioral psychology and influence triggers which are
                                                ...
                                                theory alone isn’t going to get the job done so that’s why this course
                                                is packed with practical hands-on examples that you can follow step by
                                                step.</p>
                                        </div>
                                        <!-- Collapse button -->
                                ...
                                <div class="card border rounded-3">
                                    ...
                                    <div class="card-body">
                                        <div class="row g-5">
                                            ...
                                            <div class="col-12">
                                                <!-- Curriculum item -->
                                                <h5 class="mb-4">What is Search Engine Optimization(SEO) (5
                                                    lectures)</h5>
                                                <div class="d-sm-flex justify-content-sm-between align-items-center">
                                                    <div class="d-flex">
                                                        <a href="#"
                                                    ...
                                                    <div class="d-flex">
                                                        <a href="#"
                                                           class="btn btn-danger-soft btn-round mb-0 flex-shrink-0"><i
                                                                class="fas fa-play"></i></a>
                                                        <div class="ms-2 ms-sm-3 mt-1 mt-sm-0">
                                                            <h6 class="mb-0">How to Write Title Tags Search Engines
                                                                Love</h6>
                                            ...
                                            <a class="mb-0 mt-4 btn-more d-flex align-items-center justify-content-center"
                                               ...
                                               aria-expanded="false" aria-controls="collapseCourse">
                                                See <span class="see-more mx-1">more</span><span class="see-less mx-1">less</span>
                                                video<i class="fas fa-angle-down ms-2"></i>
                                            </a>
                                ...
                                <div class="card border rounded-3">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div>
                                            ...
                                            <p class="mb-0">Preference any astonished unreserved Mrs. Prosperous
                                        ...
                                        <div class="mt-4">
                                            <h6>What is SEO?</h6>
                                            <p class="mb-0">Meant balls it if up doubt small purse. Required his you put
                                                ...
                                                possible.</p>
                                            <p class="mt-2 mb-0">Person she control of to beginnings view looked eyes
                                                ...
                                                work after mechanic But we've area wasn't everything needs of and doctor
                                                where would a of</p>
                                        </div>
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <p class="mb-0">Two before narrow not relied how except moment myself
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <p class="mb-0">Started several mistake joy say painful removed reached end.
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <p class="mb-0">Lose john poor same it case do year we Full how way even the
