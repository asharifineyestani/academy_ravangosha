                    ...
                    <div class="row position-relative">
                        ...
                        <div class="col-11 mx-auto position-relative">
                            <div class="row align-items-center">
                                <!-- Title -->
                                <div class="col-lg-7">
                                    <h3 class="text-white">{{__('static.heading.becomeInstructor')}}</h3>
                                    <p class="text-white mb-3 mb-lg-0">{{__('static.description.becomeInstructor')}}</p>
                                </div>
                                <!-- Content and input -->
                                <div class="col-lg-5 text-lg-end">
                                    <a href="/become-instructor" class="btn btn-outline-warning mb-0">{{__('static.button.becomeInstructor')}}</a>
                                </div>
                            </div>
                        </div>
                    </div> <!-- Row END -->
